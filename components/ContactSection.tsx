          ...
          <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
            ...
            <div className="pt-2 sm:pt-4">
              <button
                ...
                className="w-full sm:w-auto px-8 py-3.5 bg-[#E50914] hover:bg-[#ff2e4d] text-white font-extrabold text-xs uppercase tracking-wider transition-all duration-300 hover:scale-105 shadow-[0_0_25px_rgba(229,9,20,0.5)] disabled:opacity-50 cursor-pointer disabled:cursor-not-allowed text-center"
              >
